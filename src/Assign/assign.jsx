    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-teal-50 border-r border-teal-200 p-4">
        ...
        <nav className="space-y-2">
          ...
          <button className="w-full text-white bg-teal-700 py-2 rounded-lg">Assign Invigilator</button>
          <Link to="/profile">
            <button className="w-full text-gray-600 py-2 hover:bg-teal-100 rounded-lg">Profile</button>
          </Link>
        </nav>
      </aside>
